...
const Skill = ({icon,color,name,value})=>{
    ...
    return(
        <>
            <Divider textAlign='left' sx={{"&::before , &::after":{borderColor:`${color}.main`},mt:2}}>
            ...
            <Box sx={{width:1}}><LinearProgress color={color} variant='determinate' value={Math.round(value)} sx={{height:10,borderRadius:2}}></LinearProgress></Box>
